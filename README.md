...
Trick question, with hooks functional components can be stateful.

2. When does a componentWillMount function be called? What about a componentWillUpdate?
Before rendering and before updating, respectively.

3. Define stateful logic.
Stateful logic is any logic not related to rendering graphics.
